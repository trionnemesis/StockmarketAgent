...
- Reviewed at: `2026-08-27T16:33:55Z`
...
|---|---|---|---|---|---|---|
| [TWSE_OGL_COMPANY](https://openapi.twse.com.tw/v1/swagger.json) | TW | listing_metadata, filings_financials | none / False | partial | [open_with_attribution](https://data.gov.tw/en/license) / raw_with_attribution_allowed | conditional |
  - Limits: Not documented; cache and back off conservatively. History: Current published snapshots; complete revision history is not promised.
  - Retention: Versioned snapshots may be retained with attribution and retrieval time. Redistribution: Raw and adapted OGL records may be redistributed with attribution.
  - Fallback: Manual official filings or a separately licensed feed. Gaps: Revision semantics and full backfill are undocumented.
| [TWSE_OGL_EOD](https://data.gov.tw/dataset/11549) | TW | eod_prices | none / False | partial | [open_with_attribution](https://data.gov.tw/en/license) / raw_with_attribution_allowed | conditional |
  - Limits: Not documented; cache and back off conservatively. History: Current daily snapshot; official historical UI is not an approved bulk API.
  ...
  - Fallback: Separately licensed historical market-data feed. Gaps: No verified OGL full-history API or immutable correction stream.
